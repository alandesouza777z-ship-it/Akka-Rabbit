...
const plans = {
  semanal: [
    ...
    { name: "Pro", price: "R$ 57", period: "/semana", features: ["5 domínios protegidos", "12.500 verificações/sem", "Sistema de Cloaking (Blackhat)", "Logs de segurança (30 dias)", "Fingerprint Engine completo", "Acesso ao Grupo de Networking VIP", "Suporte prioritário"], cta: "Escolher Pro", popular: true },
    { name: "Enterprise", price: "R$ 147", period: "/semana", features: ["Domínios ilimitados", "Verificações ilimitadas", "Sistema de Cloaking (Blackhat)", "Logs permanentes", "Fingerprint Engine completo", "Acesso ao Grupo de Networking VIP", "API dedicada", "IP Whitelist/Blacklist", "Regras customizadas", "Onboarding dedicado", "Suporte 24/7", "SLA 99.9%"], cta: "Falar com Vendas", popular: false },
  ],
  mensal: [
    ...
    { name: "Pro", price: "R$ 197", period: "/mês", features: ["5 domínios protegidos", "50.000 verificações/mês", "Sistema de Cloaking (Blackhat)", "Logs de segurança (30 dias)", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "Suporte prioritário"], cta: "Escolher Pro", popular: true },
    { name: "Enterprise", price: "R$ 497", period: "/mês", features: ["Domínios ilimitados", "Verificações ilimitadas", "Sistema de Cloaking (Blackhat)", "Logs permanentes", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "API dedicada", "IP Whitelist/Blacklist", "Regras customizadas", "Onboarding dedicado", "Suporte 24/7", "SLA 99.9%"], cta: "Falar com Vendas", popular: false },
  ],
  trimestral: [
    ...
    { name: "Pro", price: "R$ 497", period: "/trimestre", features: ["5 domínios protegidos", "150.000 verificações/tri", "Sistema de Cloaking (Blackhat)", "Logs de segurança (30 dias)", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "Suporte prioritário"], cta: "Escolher Pro", popular: true },
    { name: "Enterprise", price: "R$ 1.297", period: "/trimestre", features: ["Domínios ilimitados", "Verificações ilimitadas", "Sistema de Cloaking (Blackhat)", "Logs permanentes", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "API dedicada", "IP Whitelist/Blacklist", "Regras customizadas", "Onboarding dedicado", "Suporte 24/7", "SLA 99.9%"], cta: "Falar com Vendas", popular: false },
  ]
};
