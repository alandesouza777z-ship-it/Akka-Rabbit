...
const plans = {
  semanal: [
    { name: "Starter", price: "R$ 47", period: "/semana", features: ["1 domínio protegido", "1.250 verificações/sem", "Sistema de Cloaking (Blackhat)", "Logs de segurança (7 dias)", "Suporte via email"], cta: "Começar Agora", popular: false },
    { name: "Pro", price: "R$ 97", period: "/semana", features: ["5 domínios protegidos", "12.500 verificações/sem", "Sistema de Cloaking (Blackhat)", "Logs de segurança (30 dias)", "Fingerprint Engine completo", "Acesso ao Grupo de Networking VIP", "Suporte prioritário"], cta: "Escolher Pro", popular: true },
    { name: "Enterprise", price: "R$ 247", period: "/semana", features: ["Domínios ilimitados", "Verificações ilimitadas", "Sistema de Cloaking (Blackhat)", "Logs permanentes", "Fingerprint Engine completo", "Acesso ao Grupo de Networking VIP", "API dedicada", "IP Whitelist/Blacklist", "Regras customizadas", "Onboarding dedicado", "Suporte 24/7", "SLA 99.9%"], cta: "Falar com Vendas", popular: false },
  ],
  mensal: [
    { name: "Starter", price: "R$ 147", period: "/mês", features: ["1 domínio protegido", "5.000 verificações/mês", "Sistema de Cloaking (Blackhat)", "Logs de segurança (7 dias)", "Suporte via email"], cta: "Começar Agora", popular: false },
    { name: "Pro", price: "R$ 297", period: "/mês", features: ["5 domínios protegidos", "50.000 verificações/mês", "Sistema de Cloaking (Blackhat)", "Logs de segurança (30 dias)", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "Suporte prioritário"], cta: "Escolher Pro", popular: true },
    { name: "Enterprise", price: "R$ 697", period: "/mês", features: ["Domínios ilimitados", "Verificações ilimitadas", "Sistema de Cloaking (Blackhat)", "Logs permanentes", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "API dedicada", "IP Whitelist/Blacklist", "Regras customizadas", "Onboarding dedicado", "Suporte 24/7", "SLA 99.9%"], cta: "Falar com Vendas", popular: false },
  ],
  trimestral: [
    { name: "Starter", price: "R$ 397", period: "/trimestre", features: ["1 domínio protegido", "15.000 verificações/tri", "Sistema de Cloaking (Blackhat)", "Logs de segurança (7 dias)", "Suporte via email"], cta: "Começar Agora", popular: false },
    { name: "Pro", price: "R$ 797", period: "/trimestre", features: ["5 domínios protegidos", "150.000 verificações/tri", "Sistema de Cloaking (Blackhat)", "Logs de segurança (30 dias)", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "Suporte prioritário"], cta: "Escolher Pro", popular: true },
    { name: "Enterprise", price: "R$ 1.997", period: "/trimestre", features: ["Domínios ilimitados", "Verificações ilimitadas", "Sistema de Cloaking (Blackhat)", "Logs permanentes", "Fingerprint Engine completo", "Webhooks customizados", "Acesso ao Grupo de Networking VIP", "API dedicada", "IP Whitelist/Blacklist", "Regras customizadas", "Onboarding dedicado", "Suporte 24/7", "SLA 99.9%"], cta: "Falar com Vendas", popular: false },
  ]
};
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="w-full lg:w-1/2 relative z-20">
            ...
            <div className="flex flex-wrap gap-3">
              {["Google Ads", "Facebook Ads", "TikTok Ads", "Kwai Ads"].map(ad => (
          ...
          <div className="w-full lg:w-1/2 h-[400px] sm:h-[500px] relative flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              ...
              <div className="absolute w-[340px] sm:w-[420px] h-[340px] sm:h-[420px] rounded-full border border-white/5 border-dashed" />
            </div>

            {/* Orbit 1: Facebook & TikTok */}
            <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 20, ease: "linear" }} className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-[220px] sm:w-[280px] h-[220px] sm:h-[280px] rounded-full absolute">
                {/* Facebook Logo */}
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.2)]" style={{ transform: "rotate(-0deg)" }}>
                  <svg viewBox="0 0 24 24" fill="#1877F2" className="w-8 h-8"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </div>
                {/* TikTok Logo */}
                <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-black rounded-full border border-white/20 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.2)]" style={{ transform: "rotate(-180deg)" }}>
                  <svg viewBox="0 0 448 512" fill="#FFFFFF" className="w-6 h-6 drop-shadow-[2px_2px_0_#FE2C55]"><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/></svg>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div animate={{ rotate: -360 }} transition={{ repeat: Infinity, duration: 30, ease: "linear" }} className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-[340px] sm:w-[420px] h-[340px] sm:h-[420px] rounded-full absolute">
                {/* Google Ads Logo */}
                <div className="absolute top-1/2 -left-6 -translate-y-1/2 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.2)]" style={{ transform: "rotate(90deg)" }}>
